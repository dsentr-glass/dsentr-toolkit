...
const Avatar: React.FC<AvatarProps> = ({ profile }: AvatarProps) => {
  const { username = 'Shard', image, profileLink, noProfileLink, showPip = false } = profile
  const link = profile.username != null ? profileLink : noProfileLink
