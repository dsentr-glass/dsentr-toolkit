...
import { Language, MenuProps } from './types'
...
const useProps = (): MenuProps => {
  const [props, setProps] = useState({
    ...
    setLang: noop,
    currentLang: 'EN',
    glassPriceUsd: 0.013158668932877668,
    links,
    profile: null
  })
...
export const Connected: React.FC = () => {
  const props: MenuProps = useProps()
  return (
    <BrowserRouter>
      <Menu {...props}>
        <div>
  ...
  return (
    <BrowserRouter>
      <Menu
        ...
        setLang={noop}
        currentLang='EN'
        glassPriceUsd={0.013458668932877668}
        links={links}
      >
        <div>
          <h1>Page body</h1>
  ...
  return (
    <BrowserRouter>
      <Menu
        ...
        profile={{
          username: 'dsentr',
          image: 'https://dsentr.com/images/nfts/blueberries-preview.png',
          profileLink: '/profile',
          noProfileLink: '/no-profile'
        }}
      >
