...
it('renders link correctly', () => {
  const { asFragment } = renderWithTheme(<Link href='https://dsentr.com'>Link</Link>)
...
it('renders link external link correctly', () => {
  const { asFragment } = renderWithTheme(<LinkExternal href='https://dsentr.com'>Link</LinkExternal>)
  expect(asFragment()).toMatchInlineSnapshot(`
    <DocumentFragment>
      .c0 {
      color: #23caca;
