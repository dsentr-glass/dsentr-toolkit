...
describe('contractHelpers', () => {
  ...
  it('getErc721Contract returns an instance of Contract', () => {
    ...
    expect((erc721Contract != null) ? erc721Contract.constructor.name : '').toBe('Contract')
  })
  it('uses provided Web3 instnace', () => {
    ...
    const glassShardContract = getProfileContract(customWeb3, MAINNET_CHAIN_ID)
    // eslint-disable-next-line @typescript-eslint/ban-ts-comment
    // @ts-expect-error
    expect(glassShardContract.currentProvider).toBe(httpProvider)
  })
})
